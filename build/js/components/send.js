	...
	_createClass(Send, [{
		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement("input", { type: "text", value: this.props.inputValue, onChange: function onChange(e) {
						return _this2.props.updateValue(e);
					}, className: "messages" }),
				React.createElement(
					"button",
					{ type: "button", className: "btn-message", onClick: this.props.sendMessage },
					"Send Message"
				)
			);
		}
